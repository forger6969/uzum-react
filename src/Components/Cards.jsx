        ...
        <div>
            ...
            <div className='flex flex-wrap gap-[30px] justify-between px-[150px] py-[100px]'>
                ...
                {products.map((m) => {
                    ...
                    return (
                        <div className="card w-[232px] flex flex-col gap-[6px] rounded-2xl transition-all hover:shadow-[0px_0px_3px_1px_#adadad]">
                            ...
                            <button className='h-[32px] w-full rounded-[8px] bg-[#7f4dff] flex items-center justify-center gap-[3px] text-white cursor-pointer'><img className='w-[20px] fill-white' src={basketSVG} alt="" /> {isUzb ? "Korzinaga" : "В корзину"}</button>
                        </div>
                    )
                }
